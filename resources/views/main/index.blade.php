...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Welcome To Legoom Circle!</div>
                <div class="masthead-heading text-uppercase">It's Nice To Meet You</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="{{ route('login')}}">Login</a>
                <a class="btn btn-primary btn-xl text-uppercase" href="register-page.html">Register</a>
